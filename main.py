...
from resources.road import Road
from resources.world import World
from resources.NNdraw import NN
from resources.config_variables import *
...
py.display.set_caption("Self Driving Car Neural Network BySteven")
...
def draw_win(cars, road, world, GEN):
    ...
    text = STAT_FONT.render("BySteven", 1, BLACK)
    world.win.blit(text, (world.win_width-text.get_width() - 10, 100))
